...
import com.leyou.user.dao.XcCompanyUserRepository;
import com.leyou.user.dao.XcMenuMapper;
import com.leyou.user.dao.XcUserRepository;
...
public class UserService {
    ...
    public XcUserExt getUserExt(String username){
        ...
        if(xcUser == null){
            throw new CustomGlobalRuntimeException(ExceptionEnum.USER_NOT_EXIST_EXCEPTION);
        }
        //用户id
